...
package data.base.firebase.quickstart.database;
...
import data.base.firebase.quickstart.database.fragment.MyPostsFragment;
import data.base.firebase.quickstart.database.fragment.MyTopPostsFragment;
import data.base.firebase.quickstart.database.fragment.RecentPostsFragment;
...
public class  MainActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case com.google.firebase.quickstart.database.R.id.action_logout:
