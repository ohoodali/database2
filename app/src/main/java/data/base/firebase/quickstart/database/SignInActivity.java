...
public class SignInActivity extends BaseActivity implements View.OnClickListener {
    ...
    // [END basic_write]
//how to writr code for bitbcute
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case com.google.firebase.quickstart.database.R.id.button_sign_in:
                signIn();
                break;
            case com.google.firebase.quickstart.database.R.id.button_sign_up:
                signUp();
                break;
        }
    }
