...
import data.base.firebase.quickstart.database.models.Comment;
import data.base.firebase.quickstart.database.models.Post;
import data.base.firebase.quickstart.database.models.User;
...
public class PostDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.google.firebase.quickstart.database.R.id.button_post_comment:
                postComment();
                break;
        }
    }
